...
<pre><code>
add_opts() = #{sso_opts =&gt; <a href="#type-sso_opts">sso_opts()</a>, password_opts =&gt; <a href="bondy_password.md#type-opts">bondy_password:opts()</a>}
</code></pre>
...
### <a name="type-sso_opts">sso_opts()</a> ###


<pre><code>
sso_opts() = #{realm_uri =&gt; <a href="#type-uri">uri()</a>, password =&gt; <a href="bondy_password.md#type-future">bondy_password:future()</a> | <a href="bondy_password.md#type-t">bondy_password:t()</a>, authorized_keys =&gt; [binary()], groups =&gt; [binary()], meta =&gt; #{binary() =&gt; any()}}
</code></pre>
...
<pre><code>
t() = #{type =&gt; ?TYPE, version =&gt; binary(), username =&gt; <a href="#type-username">username()</a>, groups =&gt; [binary()], password =&gt; <a href="bondy_password.md#type-future">bondy_password:future()</a> | <a href="bondy_password.md#type-t">bondy_password:t()</a>, authorized_keys =&gt; [binary()], sso_realm_uri =&gt; <a href="#type-maybe">maybe</a>(<a href="#type-uri">uri()</a>), meta =&gt; #{binary() =&gt; any()}, sso_opts =&gt; <a href="#type-sso_opts">sso_opts()</a>, password_opts =&gt; <a href="bondy_password.md#type-opts">bondy_password:opts()</a>}
</code></pre>
...
<pre><code>
update_opts() = #{forward_credentials =&gt; boolean(), update_credentials =&gt; boolean(), sso_opts =&gt; <a href="#type-sso_opts">sso_opts()</a>, password_opts =&gt; <a href="bondy_password.md#type-opts">bondy_password:opts()</a>}
</code></pre>
...
<code>RealmUri</code>.</td></tr><tr><td valign="top"><a href="#resolve-1">resolve/1</a></td><td>If the user <code>User</code> is no sso-managed, returns <code>User</code> unmodified.</td></tr><tr><td valign="top"><a href="#sso_realm_uri-1">sso_realm_uri/1</a></td><td>Returns the URI of the Same Sign-on Realm in case the user is a SSO
...
If the user `User` is no sso-managed, returns `User` unmodified.
...
<pre><code>
update(RealmUri::<a href="#type-uri">uri()</a>, Username::binary(), Data::map(), Opts::<a href="#type-update_opts">update_opts()</a>) -&gt; {ok, NewUser::<a href="#type-t">t()</a>} | {error, any()}
</code></pre>
<br />
