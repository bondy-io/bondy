...
<pre><code>
add_grant(RealmUri::binary(), RoleList::<a href="#type-userlist">userlist()</a>, Bucket::<a href="#type-bucket">bucket()</a> | any, Grants::[binary()]) -&gt; ok | {error, term()}
</code></pre>
<br />
...
<pre><code>
add_group(RealmUri::binary(), Groupname::string(), Options::[{string(), term()}]) -&gt; ok | {error, reserved_name | role_exists | illegal_name_char}
</code></pre>
<br />
...
<pre><code>
add_revoke(RealmUri::binary(), RoleList::<a href="#type-userlist">userlist()</a>, Bucket::<a href="#type-bucket">bucket()</a> | any, Revokes::[string()]) -&gt; ok | {error, term()}
</code></pre>
<br />
...
<pre><code>
add_user(RealmUri::binary(), Username::string(), Options::[{binary(), term()}]) -&gt; ok | {error, reserved_name | role_exists | illegal_name_char}
</code></pre>
<br />
...
<pre><code>
authenticate(RealmUri::<a href="#type-uri">uri()</a>, Username::binary(), Password::binary() | {hash, binary()}, ConnInfo::[{atom(), any()}]) -&gt; {ok, <a href="#type-context">context()</a>} | {error, {unknown_user, binary()} | missing_password | no_matching_sources}
</code></pre>
<br />
...
<pre><code>
find_bucket_grants(Realm::binary(), Bucket::<a href="#type-bucket">bucket()</a>, Type::user | group) -&gt; [{RoleName::string(), [<a href="#type-permission">permission()</a>]}]
</code></pre>
<br />
...
<pre><code>
find_one_user_by_metadata(Realm::binary(), Key::<a href="#type-metadata_key">metadata_key()</a>, Value::<a href="#type-metadata_value">metadata_value()</a>) -&gt; {Username::string(), <a href="#type-options">options()</a>} | {error, not_found}
</code></pre>
<br />
...
<pre><code>
find_unique_user_by_metadata(Realm::binary(), Key::<a href="#type-metadata_key">metadata_key()</a>, Value::<a href="#type-metadata_value">metadata_value()</a>) -&gt; {Username::string(), <a href="#type-options">options()</a>} | {error, not_found | not_unique}
</code></pre>
<br />
...
<pre><code>
find_user(Realm::binary(), Username::string()) -&gt; <a href="#type-options">options()</a> | {error, not_found}
</code></pre>
<br />
...
<pre><code>
lookup_group(RealmUri::binary(), Name::binary()) -&gt; tuple() | {error, not_found}
</code></pre>
<br />
...
<pre><code>
lookup_user(RealmUri::binary(), Username::binary()) -&gt; tuple() | {error, not_found}
</code></pre>
<br />
