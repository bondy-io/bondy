...
handle_peer_message(#result{} = M, Caller, _Callee, _Opts) ->
    ...
    Fun = fun(Id, LocalCaller) when Id =:= CallId ->
...
dequeue_call(Hint, Fun, RealmUri) when is_function(Fun, 2) ->
