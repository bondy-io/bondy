...
resolve(?BONDY_RBAC_GROUP_ADD_OLD) ->
	?BONDY_RBAC_GROUP_ADD;
resolve(?BONDY_RBAC_GROUP_DELETE_OLD) ->
	?BONDY_RBAC_GROUP_DELETE;
resolve(?BONDY_RBAC_GROUP_FIND_OLD) ->
	?BONDY_RBAC_GROUP_FIND;
resolve(?BONDY_RBAC_GROUP_LIST_OLD) ->
	?BONDY_RBAC_GROUP_LIST;
resolve(?BONDY_RBAC_GROUP_UPDATE_OLD) ->
	?BONDY_RBAC_GROUP_UPDATE;
resolve(?BONDY_RBAC_SOURCE_ADD_OLD) ->
	?BONDY_RBAC_SOURCE_ADD;
resolve(?BONDY_RBAC_SOURCE_DELETE_OLD) ->
	?BONDY_RBAC_SOURCE_DELETE;
resolve(?BONDY_RBAC_SOURCE_FIND_OLD) ->
	?BONDY_RBAC_SOURCE_FIND;
resolve(?BONDY_RBAC_SOURCE_LIST_OLD) ->
	?BONDY_RBAC_SOURCE_LIST;
resolve(?BONDY_RBAC_USER_ADD_OLD) ->
	?BONDY_RBAC_USER_ADD;
resolve(?BONDY_RBAC_USER_CHANGE_PASSWORD_OLD) ->
	?BONDY_RBAC_USER_CHANGE_PASSWORD;
resolve(?BONDY_RBAC_USER_DELETE_OLD) ->
	?BONDY_RBAC_USER_DELETE;
resolve(?BONDY_RBAC_USER_FIND_OLD) ->
	?BONDY_RBAC_USER_FIND;
resolve(?BONDY_RBAC_USER_LIST_OLD) ->
	?BONDY_RBAC_USER_LIST;
resolve(?BONDY_RBAC_USER_UPDATE_OLD) ->
	?BONDY_RBAC_USER_UPDATE;
