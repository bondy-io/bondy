 ...
 {bondy_broker_bridge,
    ...
    {eleveldb,
     [{whole_file_expiry,true},
      ...
      {data_root,"/Users/aramallo/tmp/bondy/data/leveldb"},
      {compression,snappy},
      {delete_threshold,1000},
      {tiered_slow_level,0}]},
    {flake,
        [{allowable_downtime,2592000000},
        {timestamp_path,"/Users/aramallo/tmp/bondy/tmp/flake_timestamp.dets"}]},
    {plumtree,[{broadcast_exchange_timer,60000},{broadcast_mods,[plum_db]}]},
    {partisan,
        [{tls_options,
            [{cacertfile,"/Users/aramallo/tmp/bondy/etc/cacert.pem"},
            {keyfile,"/Users/aramallo/tmp/bondy/etc/key.pem"},
            {certfile,"/Users/aramallo/tmp/bondy/etc/cert.pem"}]},
        {tls,false},
        {parallelism,1},
        {peer_port,18086},
