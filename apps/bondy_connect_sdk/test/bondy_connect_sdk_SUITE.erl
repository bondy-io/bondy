...
-module(bondy_connect_sdk_SUITE).
...
app_starts_and_stops(_) ->
    ...
    _ = application:stop(bondy_connect_sdk),
    {ok, Started} = application:ensure_all_started(bondy_connect_sdk),
    ?assert(lists:member(bondy_connect_sdk, Started)),
    ...
    ok = application:stop(bondy_connect_sdk),
