-module(bondy_http_connector_mock_auth).

-moduledoc """
Mock authentication module for testing.

Implements `bondy_http_connector_auth_proxy` by reading tokens from the
...
bondy_http_connector_mock_auth:set_token(<<"test-token">>, #{expires_in => 300}).

%% Simulate a failure
bondy_http_connector_mock_auth:set_error(token_endpoint_down).

%% Track how many times fetch_token was called
bondy_http_connector_mock_auth:reset_call_count().
Count = bondy_http_connector_mock_auth:call_count().
```
""".

-behaviour(bondy_http_connector_auth_proxy).
...
%% ===================================================================
%% bondy_http_connector_auth_proxy callbacks
%% ===================================================================
