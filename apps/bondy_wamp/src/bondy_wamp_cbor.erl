...
-define(DEFAULT_DECODE_OPTS, [
    {decoders, #{null => undefined, undefined => undefined}}
]).
...
decode_head(Bin, NumElements) when
    is_binary(Bin), is_integer(NumElements), NumElements > 0
->
