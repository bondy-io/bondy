...
![Docker Build (latest-tag)](https://img.shields.io/github/actions/workflow/status/bondy-io/bondy/docker_image_build.yaml?&tag=version-1.0.0-rc.44&label=docker-1.0.0-rc.44&style=for-the-badge)
...
```shell
tar -zxvf _build/prod/rel/bondy-1.0.0-rc.44.tar.qz -C ~/tmp/bondy
```
