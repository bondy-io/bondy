...
If you want to define your own `client_id` and `client_secret` do:
```bash
curl -X "POST" "http://localhost:18081/realms/magenta/clients" \
...
An example return will the followin JSON object
```json
{
