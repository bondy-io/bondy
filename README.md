...
![Docker Build (latest-tag)](https://img.shields.io/github/actions/workflow/status/bondy-io/bondy/docker_image_build.yaml?&tag=version-1.0.0-rc-jade&label=docker-1.0.0-rc-jade&style=for-the-badge)
